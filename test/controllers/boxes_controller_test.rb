...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post boxes_url, params: { box: { kind: @box.kind, number: @box.number, user_id: @box.user_id } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { kind: @box.kind, number: @box.number, user_id: @box.user_id } }
